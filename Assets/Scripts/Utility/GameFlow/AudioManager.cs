...
namespace Utility.GameFlow
{
    public class AudioManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _PlayClipOneShotCustomHelper += PlayOneShot;
        ...
        private void Start()
        {
            ChangeMixerVolume("MasterVolume", PlayerPrefs.GetFloat("MasterVolume", 0.5f));
            ChangeMixerVolume("MusicVolume", PlayerPrefs.GetFloat("MusicVolume", 0.5f));
            ChangeMixerVolume("SFXVolume", PlayerPrefs.GetFloat("SFXVolume", 0.5f));
            ChangeMixerVolume("AmbientVolume", PlayerPrefs.GetFloat("AmbientVolume", 0.5f));
        }
